...
Cadence es un nuevo lenguaje de programación de contratos inteligentes que se utiliza en la Blockchain Flow. Cadence introduce nuevas característicaas en la programación de contratos inteligentes que ayudan a los desarrolladores a garantizar que su código es confiable, seguro, claro y entendible. Algunas de esas características son: 

- Seguridad de tipos y un sistema de tipos estático robusto. 
- Programación orientada a recursos, un nuevo paradigma que empareja los tipos lineaales con capacidades de objetos para crear un modelo seguro y declarativo para la propiedad digital garantizando que los recursos (y sus assets asociados) solo pueden existir en una loclización a un mismo tiempo, no pueden ser copiados, y no pueden perderse o borrarse accidentalmente. 
- Pre-condiciones y post-condiciones incorporadas en las funciones y las transacciones [transactions](/intro/glossary/#transaction)
